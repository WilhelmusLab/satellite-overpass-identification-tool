...
def test_main_regression_2025_05_15_80n_105w(credentials, monkeypatch, tmp_path, domain, use_rate_limited_get_data):
...
@pytest.mark.integration
def test_main_regression_directory_output_2025_05_15_80n_105w(credentials, monkeypatch, tmp_path, domain, use_rate_limited_get_data):
